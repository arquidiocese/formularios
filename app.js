    ...
    secoes: [
      {
        ...
        campos: [
          ...
          { id: 'cat_horarios', label: 'Quais os dias e horários das aulas?', tipo: 'textarea' },
          ...
          { id: 'cat_duracao', label: 'Duração do curso (quantos anos/meses)', tipo: 'text' },
          { id: 'cat_local', label: 'Local das aulas', tipo: 'text' },
